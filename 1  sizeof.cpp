...
//#pragma pack(2)                      // https://blog.csdn.net/hairetz/article/details/4084088
union un1
{  
	char buffer[13];  
	int number;  
...
int main()
{
	...
	cout << "int	n: " << sizeof(n) << endl;
	cout << "s2: " << sizeof(s2) << endl;
	cout << "malloc	p2: " << sizeof(p2) << endl;

	cout << "纯指针	pint: " << sizeof(pint) << "	p111: " << sizeof(p111) << endl;

	cout << "struct	ss1: " << sizeof(ss1) << endl;
	cout << "struct	ss2: " << sizeof(ss2) << endl;

	cout << "union: " << sizeof(ubu) << endl;
	cout << "bu: " << sizeof(bu) << endl;                  //一个Class对象占用内存空间为非静态成员变量总和+ 数据对齐处理+虚函数
